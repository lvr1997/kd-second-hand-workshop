...
**‼️‼️在此说一下，用这个项目做毕设的同学注意了‼️只要有一点SSM基础跑起来是绝对没问题的。0基础的小白最好先补充一点基础知识再来。觉得有用的可以点个star，觉得没有用的就划过。作者在本地项目运行是没问题的。新导入的项目如果跑不起来请移步我的B站，有讲解视频。👉[【科大二手工坊项目配置教程-哔哩哔哩】](https://www.bilibili.com/video/BV1AYzyYqENo/?share_source=copy_web)下方原有的QQ群入口已经关闭**
